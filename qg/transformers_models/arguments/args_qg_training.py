...
encoder_parser.add_argument('--batch_size', type=int, default=32, help='Specify the training batch size')
encoder_parser.add_argument('--preprocess_setting', type=str, default="basic", help="'AQPL', 'OQPL', 'AA' or 'basic'")
...
encoder_parser.add_argument('--n_epochs', type=int, default=10, help='Number of training epochs')
...
# encoder_parser.add_argument('--debug', type=bool, default=False, help='Set to true for testing the code, it will un a shortcut')
encoder_parser.add_argument('--dataset', type=str, default="squad_v2", help='Select the dataset')
encoder_parser.add_argument('--test', type=bool, default=False, help='Specify the training batch size')
